...
hakufont = ['ᴀ','ʙ','ᴄ','ᴅ','ᴇ','ꜰ','ɢ','ʜ','ɪ','ᴊ','ᴋ','ʟ','ᴍ','ɴ','ᴏ','ᴘ','Q','ʀ','ꜱ','ᴛ','ᴜ','ᴠ','ᴡ','x','ʏ','ᴢ']
@ultroid_cmd(pattern="haku ?(.*)")
async def hakutxt(ult):
    ...
    for normiecharacter in string:
        if normiecharacter in normiefont:
            hakucharacter = hakufont[normiefont.index(normiecharacter)]
            string = string.replace(normiecharacter, hakufont)
